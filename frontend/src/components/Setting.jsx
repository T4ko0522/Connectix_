  ...
  return (
    <StyledWrapper>
      <AnimatedAlert
        ...
        severity="error"
        title="Error"
        message="このページはまだ完成していません；；"
      />
      <div className="input">
      <button className="value" onClick={() => navigate('/dashboard')}> 
